...
#include "main.h"
#include "usb_host.h"
#include "bmp280.h"  // Inclure la bibliothèque BMP280
...
/* USER CODE BEGIN PV */
BMP280_HandleTypedef bmp280;  // Déclarer une instance de BMP280
/* USER CODE END PV */
...
/* USER CODE BEGIN PFP */
void Error_Handler(void);  // Déclarer la fonction Error_Handler
/* USER CODE END PFP */
...
{
  /* USER CODE BEGIN 1 */
  bmp280_params_t params;  // Déclarer une structure pour les paramètres BMP280
  /* USER CODE END 1 */
